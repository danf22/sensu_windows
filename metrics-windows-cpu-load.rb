#! /usr/bin/env ruby
#
#   metrics-windows-cpu-load.rb modificado por daniel felipe morales para windows server en español
#
# DESCRIPTION:
...
class CpuMetric < Sensu::Plugin::Metric::CLI::Graphite
  ...
  def acquire_cpu_load
    ...
    IO.popen("typeperf -sc 1 \"Procesador(_total)\\% de tiempo de procesador\" ") { |io| io.each { |line| temp_arr.push(line) } }
