#! /usr/bin/env ruby
#
#   metrics-windows-cola_impresion_trabajos_en_cola.rb
#
# DESCRIPTION:
#   este script solo es para windows server en español
#
# OUTPUT:
#   metric data
#
...
class CpuMetric < Sensu::Plugin::Metric::CLI::Graphite
  ...
  def cola_impresion
    ...
    IO.popen("typeperf -sc 1 \"*(_Total)\\Trabajos en cola\" ") { |io| io.each { |line| temp_arr.push(line) } }
